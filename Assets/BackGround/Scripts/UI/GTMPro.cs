...
using UnityEditor;
using static ResourceManager.ObjectPool;
...
public partial class GTMPro : MonoBehaviour
{
    ...
    public void SetEditString()
    {
        ...
        
        {
            ...
            {
                default:
                    fontKey = "LilitaOne-Regular Outline 40 SDF.asset";
                    matKey = $"{text.fontSharedMaterial.name}.mat";
                    break;
            }
            var font_assetPath = ZString.Concat("Assets/BackGround/ui/font/", fontKey);
            ...
            var mat_assetPath = ZString.Concat("Assets/BackGround/ui/font/", matKey);
    ...
    {
        string path = "Assets/BackGround/Prefabs/scripts/string/stringEnglish.json";
    ...
    public void SetText<T1, T2>(T1 arg1, T2 arg2)
    {
        ...
        if (text)
        {
            text.text = ZString.Format(Managers.String.GetString(stringID, strFileType), arg1, arg2);
        }
    }
